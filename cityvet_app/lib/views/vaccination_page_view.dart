                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoRow('Owner', widget.animalModel.owner!, Icons.person),
                      _buildInfoRow('Color', widget.animalModel.color, Icons.palette),
                      _buildInfoRow('Unique Spot', widget.animalModel.uniqueSpot ?? 'No unique spot', Icons.fingerprint),
                      _buildInfoRow('Known Conditions', widget.animalModel.knownConditions ?? 'No known conditions', Icons.medication, isLast: true),
                    ],
                  ),
                ),
