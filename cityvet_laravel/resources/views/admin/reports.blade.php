        ...
        <table class="table-auto w-full border-collapse">
            <thead class="bg-[#d9d9d9] text-left text-[#3D3B3B]">
                <tr>
                    ...
                    <th class="px-4 py-2 font-medium rounded-tr-xl">Administered by</th>
                </tr>
            </thead>
            <tbody>
                @forelse($vaccinationReports as $index => $report)
                    <tr class="hover:bg-gray-50 border-t text-[#524F4F]"
                        ...
                        <td class="px-4 py-2">{{ ucfirst($report->animal_type) }}</td>
                    ...
                    <tr>
                        <td colspan="10" class="text-center py-8 text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-gray-500">No vaccination reports available in the system.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
    ...
    <div x-show="activeTab === 'bite-case'" class="w-full bg-white rounded-xl p-[2rem] shadow-md overflow-x-auto">
        <div class="text-center py-8 text-gray-500">
            <div class="flex flex-col items-center">
                ...
                <p class="text-gray-500">To be implement (:</p>
            </div>
        </div>
    </div>
</div>
