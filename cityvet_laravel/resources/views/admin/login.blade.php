        ...
        <div class="lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            ...
            <form class="space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" placeholder="Enter your Password" class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-700">
